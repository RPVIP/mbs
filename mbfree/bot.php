<?php 
define('BOT_TOKEN', '1810026716:AAGkcBWjIlvzHugniHfxqjWNXLswf2dMiIQ'); 
...
*AÃ§Ã£o: BANIDO! ðŸš·*", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'âœ„1¤7  Desbanir  âœ„1¤7',"callback_data"=>"unban $id[1] $id[2] $id[3]")//botÃ£o com callback                                                                                              
                                                      )
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'âœ„1¤7  Desbanir  âœ„1¤7',"callback_data"=>"unban $id[1] $id[2]")//botÃ£o com callback                                                                                              
                                                      )
          ...
          apiRequest("answerCallbackQuery", array('callback_query_id' => $callback_id, 'text' => "ðŸ“› VocÃª precisa ser um ðŸ‘®ðŸ» Admin ou ðŸ‘·ðŸ»â€â™‚ Moderador e precisa ter permissÃ£o para realizar essa aÃ§Ã£o", "show_alert" => true));
      }
      ...
      if($status == 'creator' || $permissao == 'true') {        
          ...
          if($id[3]) {
              apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "[@$id[3]](tg://user?id=$id[1]) *[*`".$id[1]."`*]*
*AÃ§Ã£o: BANIDO! ðŸš·*
*~ DESBANIDO! âœ„1¤7*", "reply_to_message_id" => $message_id)); 
...
*~ DESBANIDO! âœ„1¤7*", "reply_to_message_id" => $message_id)); 
      ...
      if($status == 'creator' || $permissao == 'true') {     
          ...
          if($id[3]) {
              apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "[@$id[3]](tg://user?id=$id[1]) *[*`".$id[1]."`*]*
*AÃ§Ã£o: SILENCIADO! ðŸ”‡*", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'âœ„1¤7  Dessilenciar  âœ„1¤7',"callback_data"=>"unmute $id[1] $id[2] $id[3]")//botÃ£o com callback                                                                                              
                                                      )
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'âœ„1¤7  Dessilenciar  âœ„1¤7',"callback_data"=>"unmute $id[1] $id[2]")//botÃ£o com callback                                                                                              
                                                      )
...
*Escolha uma das opÃ§Ãµes a baixo e clique no botÃ£o correspondente.*',
		    'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'âž• Adicione-me a um grupo âž•','url'=>'https://t.me/StarkConsultasbot?startgroup=start')                                           
                                                      ),
                                                     //linha 2
                                                     array(
                                                         array('text'=>'ðŸ†™ Checkers ',"callback_data"=>'checkers'),                                               
                                                         array('text'=>'Consultas ðŸ”',"callback_data"=>'consultas')
                                                      ),
                                                     //linha 3
                                                     array(                                                                                                               
                                                         array('text'=>'ðŸ’Ž Planos ðŸ’Ž',"callback_data"=>'queroservip')//botÃ£o com callback 
                                                      ),                                                      
                                                     //linha 4
                                                     array(
                                                          array('text'=>'ðŸ”† Comandos ',"callback_data"=>'comandosgrupos'),//botÃ£o com callback                                
                                                          array('text'=>' Geradores âš™',"callback_data"=>'geradores')
                                                      ),                                                   
                                                     //linha 5
                                                     array(                     
                                                         array('text'=>'ðŸ‘¥ Grupo','url'=>'https://t.me/joinchat/Gz9LjyUVoJ3M6EmB'),                                                                                  
                                                         array('text'=>'Canal ðŸ“¢','url'=>'https://t.me/StarkRefs')                                                 
                                                      ),
                                                     //linha 6
                                                     array(                                               
...
Para continuar me coloque como administrador. ðŸ˜‰"));             
          }else{              
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”˜  Menu  ðŸ”˜',"callback_data"=>'menu'), //botÃ£o 1                                                 
                                                      )
...
*ðŸ’Ž ð—§ð—”ð—•ð—˜ð—Ÿð—” ð——ð—˜ ð—£ð—¥ð—˜ð—–Ì§ð—¢ð—¦ ðŸ’Ž
âœ…Â  1 SEMANA  20 R$
âœ…Â  2 SEMANAS 35 R$
âœ…Â  1 MES 60 R$ 
âœ…Â  2 MESES  110 R$
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
    ...
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => '
*ðŸ’Ž ð™ð˜¼ð˜½ð™€ð™‡ð˜¼ ð˜¿ð™€ ð™‹ð™ð™€ð˜¾Ì§ð™Šð™Ž ð™‚ð™ð™ð™‹ð™Š ð™‘ð™„ð™‹ ðŸ’Ž
âœ… 07 DIAS  15 R$ 
âœ… 15 DIAS  35 R$ 
âœ… 1 MES  90 R$*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”™  Voltar  ðŸ”™',"callback_data"=>'menu'), //botÃ£o 1                                                                                                     
                                                      )
    ...
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => 'ðŸ” *MENU DE CONSULTAS*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ” CONSULTAS VIP ðŸ”',"callback_data"=>'consultasvip'), //botÃ£o 1                                              
                                                      ),
                                                       //linha 2
                                                     array(
                                                         array('text'=>'ðŸ” CONSULTAS GRÃTIS ðŸ”',"callback_data"=>'consultasfree'), //botÃ£o 1                                              
                                                      ),                                                      
                                                       //linha 3
                                                     array(
                                                         array('text'=>'ðŸ”™  Voltar  ðŸ”™',"callback_data"=>'menu'), //botÃ£o 1                                              
    ...
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => 'ðŸ” *CONSULTAS VIP*
*â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”*
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”™  Voltar  ðŸ”™',"callback_data"=>'consultas'), //botÃ£o 1                                              
                                                      )
    ...
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => 'ðŸ” *CONSULTAS GRÃTIS*
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
      ...
      apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => 'ðŸ”† *COMANDOS PARA GRUPO
ðŸ‘¥ DisponÃ­vel para todos o usuÃ¡rios
ðŸ‘®ðŸ» DisponÃ­vel para Admins
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
â€¢ UsuÃ¡rios*
ðŸ‘¥ `/id`  *fornece informaÃ§Ãµes sobre o prÃ³prio usuÃ¡rio.*
ðŸ‘¥ `/link`  *fornece link do grupo.*
*â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
â€¢ Mensagens Fixadas*
ðŸ‘®ðŸ» `/pin`  *fixa mensagem respondida.*
ðŸ‘®ðŸ» `/unpin`  *remove a mensagem fixada.*
*â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
â€¢ AdministraÃ§Ã£o*
ðŸ‘®ðŸ» `/info`  *fornece informaÃ§Ãµes sobre o usuÃ¡rio.*
ðŸ‘®ðŸ» `/infopvt`  *mesma funÃ§Ã£o do* `/info`*, porÃ©m envia as informaÃ§Ãµes no chat privado.*
ðŸ‘®ðŸ» `/ban`  *banir usuÃ¡rio do grupo sem possibilidade de retorno atravÃ©z do link do grupo.*
ðŸ‘®ðŸ» `/mute`  *permite que um usuÃ¡rio leia as mensagens porÃ©m nÃ£o pode escrever no grupo.*
ðŸ‘®ðŸ» `/unban`  *usado com usuÃ¡rios banidos, permitindo o retorno atravÃ©z do link do grupo.*
ðŸ‘®ðŸ» `/unmute`  *usado com usuÃ¡rios silenciados, permitindo que o usuÃ¡rio volte a escrever no grupo.*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”™  Voltar  ðŸ”™',"callback_data"=>'menu'), //botÃ£o 4                                                      
                                                      ),
                                                      //linha 2
                                                     array(
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”  Atualizar  ðŸ”',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'gerardadosdemulher']))//botÃ£o com callback                                                   
                                                      ),
                                                     //linha 1
                                                     array(
                                                         array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botÃ£o com callback                                                   
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”  Atualizar  ðŸ”',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'gerardadosdehomem']))//botÃ£o com callback                                                   
                                                      ),
                                                     //linha 1
                                                     array(
                                                         array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botÃ£o com callback                                                   
           ...
           'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                       //linha 1
                                                         array(
                                                          ...
                                                          //linha 2
                                                         array(
                                                             array('text'=>'ðŸ”  Atualizar  ðŸ”',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'cpfgen10']))//botÃ£o com callback                                                   
                                                          ),                                                          
                                                           //linha 3
                                                         array(
                                                             array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botÃ£o com callback                                                                                                      
           ...
           'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                       //linha 1
                                                         array(
                                                          ...
                                                          //linha 2
                                                         array(
                                                             array('text'=>'ðŸ”  Atualizar  ðŸ”',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'cpfgen30']))//botÃ£o com callback                                                   
                                                          ),                                                          
                                                           //linha 3
                                                         array(
                                                             array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botÃ£o com callback                                                                                                      
           ...
           'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                       //linha 1
                                                         array(
                                                          ...
                                                          //linha 2
                                                         array(
                                                             array('text'=>'ðŸ”  Atualizar  ðŸ”',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'cpfgen50']))//botÃ£o com callback                                                   
                                                          ),                                                          
                                                           //linha 3
                                                         array(
                                                             array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botÃ£o com callback                                                                                                      
...
apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "ðŸ‡§ðŸ‡·  *PROXY HTTP
...
apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "ðŸ‡ºðŸ‡¸  *PROXY HTTP
PROXY NÃƒO ENCONTRADO!*
*BY:* @StarkConsultasbot",
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
...
apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "ðŸ‡§ðŸ‡·  *PROXY SOCKS4
PROXY NÃƒO ENCONTRADO!*
*BY:* @StarkConsultasbot",
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
...
apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "ðŸ‡ºðŸ‡¸  *PROXY SOCKS4
PROXY NÃƒO ENCONTRADO!*
*BY:* @StarkConsultasbot",
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
...
apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "ðŸ‡º??  *PROXY SOCKS4*
`$titulos`
*BY:* @StarkConsultasbot",
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
...
apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "ðŸ‡ºðŸ‡¸  *PROXY SOCKS5
PROXY NÃƒO ENCONTRADO!*
*BY:* @StarkConsultasbot",
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
...
Para utilizar todas as minhas ferramentas vocÃª precisa me colocar como administrador ðŸ˜‰*',
		    'reply_markup' => array('inline_keyboard' => array(                                                      
                                                      //linha 1
                                                     array(                                               
...
`/cep 70040010`",
   'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>'apagar')//botÃ£o com callback                                                   
                                                      )
...
`/email andreia@yahoo.com`", "reply_to_message_id" => $message_id,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'??  Apagar  ðŸ—‘',"callback_data"=>'apagar')//botÃ£o com callback                                                             
                                                      )
           ...
           include("botger/empresa/estadoemp.php");
		     ...
		     'reply_markup' => array('inline_keyboard' => array(
                                                         ...
                                                         array(
                                                          ...
                                                          //linha 2
                                                         array(
                                                             array('text'=>'ðŸ”™  Voltar  ðŸ”™',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'menu']))//botÃ£o com callback                                                   
                                                          ),
                                                           //linha 3
                                                         array(
                                                             array('text'=>'ðŸ—‘  Apagar  ðŸ—‘',"callback_data"=>serialize(['id'=>$user_id, 'data'=>'apagar']))//botÃ£o com callback                                                                                                      
               ...
               if ($user_id == $adm || $user_id == $adm2) {
                   ...
                   for($i=0;$i<count($array_usuarios);$i++){
                    ...
                    if($continuar){
                       ...
                       apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "ðŸš« *O usuÃ¡rio jÃ¡ estÃ¡ na lista VIP*
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
            ...
            if($login){
               ...
               if ($user_id == $adm || $user_id == $adm2) {
                   ...
                   if(!$continuar){
                       ...
                       apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "ðŸš« *O usuÃ¡rio nÃ£o estÃ¡ na lista VIP*
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
               ...
               if($user_id == $adm || $user_id == $adm2) {
                   ...
                   for($i=0;$i<count($array_grupos);$i++){
                    ...
                    if($continuar){
                       ...
                       apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "ðŸš« *O grupo jÃ¡ estÃ¡ na lista VIP*
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
            ...
            if($login){
               ...
               if($user_id == $adm || $user_id == $adm2) {
                   ...
                   if(!$continuar){
                       ...
                       apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "ðŸš« *O grupo nÃ£o estÃ¡ na lista VIP*
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
     ...
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
       ...
       if(strpos($text, "/lista") === 0) {
            ...
            if ($user_id == $adm) {
                ...
                apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "ðŸ“‹ *Lista de UsuÃ¡rios VIP*
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
ID de UsuÃ¡rio  |  Data de Vencimento
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
$lista
...
*AÃ§Ã£o: DESBANIDO!* âœ…", "reply_to_message_id" => $message_id)); 
           ...
           if($status == 'creator' || $permissao == 'true') {
            ...
            if($user_id == $adm) {
                ...
                apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*INFORMAÃ‡Ã•ES DO USUÃRIO:
ID: *`".$forward_from_id."`
                   ...
                   if($status == 'creator' || $status == 'administrator') {
                       ...
                       if ($member_status != 'Membro') {
                           if ($member_username) {
                               ...
                               apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*ðŸ“ INFORMAÃ‡Ã•ES DO USUÃRIO:
ðŸ†”:* `".$member_id."`
*ðŸ¤– Bot:* $member_is_bot
*ðŸ§‘ðŸ» Nome: * [$member_name](tg://user?id=$member_id)
*ðŸŒ Username: * [@$member_username](tg://user?id=$member_id)
*ðŸ‘€ SituaÃ§Ã£o:* $member_status", "reply_to_message_id" => $message_id));
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”‡ Silenciar ',"callback_data"=>"mute $reply_to_message_user_id $reply_to_message_name $reply_to_message_user"),//botÃ£o com callback                                                                                             
                                                         array('text'=>'ðŸš· Ban ',"callback_data"=>"ban $reply_to_message_user_id $reply_to_message_name $reply_to_message_user")//botÃ£o com callback
                                                      )
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'ðŸ”‡ Silenciar ',"callback_data"=>"mute $reply_to_message_user_id $reply_to_message_name"),//botÃ£o com callback                                                                                              
                                                         array('text'=>'ðŸš· Ban ',"callback_data"=>"ban $reply_to_message_user_id $reply_to_message_name")//botÃ£o com callback
                                                    )
               ...
               if(!$reply_to_message_user_id){
                   ...
                   if($status == 'creator' || $status == 'administrator') {               
                       ...
                       if ($member_username) {
                           ...
                           apiRequest("sendMessage", array('chat_id' => $user_id, "parse_mode" => "Markdown", "text" => "*ðŸ“ INFORMAÃ‡Ã•ES DO USUÃRIO:
ðŸ†”:* `".$member_id."`
*ðŸ¤– Bot:* $member_is_bot
*ðŸ§‘ðŸ» Nome: * [$member_name](tg://user?id=$member_id)
*ðŸŒ Username: * [@$member_username](tg://user?id=$member_id)
*ðŸ‘€ SituaÃ§Ã£o:* $member_status")); 
        ...
        case '/id': 
            ...
            if($type == 'private') {
                ...
                if ($username != "") {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*ðŸ“ INFORMAÃ‡Ã•ES DO USUÃRIO:
ðŸ†”:* `".$user_id."`
*ðŸ§‘ðŸ» Nome:* $first_name $last_name
*ðŸŒ Username: *[@$username](tg://user?id=$user_id)", "reply_to_message_id" => $message_id));          
                } else {
                	
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*ðŸ“ INFORMAÃ‡Ã•ES DO USUÃRIO:
ðŸ†”:* `".$user_id."`
*ðŸ§‘ðŸ» Nome:* $first_name $last_name", "reply_to_message_id" => $message_id));          
                }
                ...
                if ($username != "") {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*ðŸ“ INFORMAÃ‡Ã•ES DO GRUPO:
Chat ID:* `".$chat_id."`
*Titulo:* $titulo
*ðŸ“ INFORMAÃ‡Ã•ES DO USUÃRIO:*
*ðŸ†”:* `".$user_id."`
*ðŸ§‘ðŸ» Nome:* $first_name $last_name
*ðŸŒ Username: *[@$username](tg://user?id=$user_id)", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
...
*Meu nome Ã© @StarkConsultasbot. Adicione-me em um grupo e me coloque como Admin para utilizar todos os meus recursos!
